...
@section('title', 'تعديل جهة تقاضي | ' . $appName)
...
<style>
    ...
    .form-card { 
        ...
        border-radius: 12px; padding: 2.5rem 2rem; width: 100%; max-width: 600px; /* ملموم زي صفحة الإضافة */
...
<div class="create-page-container">
    ...
    <div class="form-wrapper">
        <div class="form-card">
            <form action="{{ route('jurisdictions.update', $jurisdiction->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
